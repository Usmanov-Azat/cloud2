...
import { getFiles, getFilesCounter, uploadFile } from '../../actions/file'
...
const Disk = () => {
    ...
    const getFilesCount = (files) => {
        const fileCount = files.map(async (file) => {
            debugger
            return {
                ...file,
                filesCount: await getFilesCounter(file._id, null),
            }
        })
